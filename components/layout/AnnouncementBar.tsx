...
export function AnnouncementBar() {
  return (
    <div className="fixed inset-x-0 top-0 z-[1100] min-h-9 border-b border-white/10 bg-[#111] px-4 py-2 text-center text-[10px] font-medium leading-4 text-white/80 sm:text-xs">
