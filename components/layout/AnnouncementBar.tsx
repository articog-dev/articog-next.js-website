...
export function AnnouncementBar() {
  return (
    <div className="fixed inset-x-0 top-0 z-[1100] min-h-9 whitespace-nowrap border-b border-white/10 bg-[#111] px-4 py-2 text-center text-[10px] font-medium text-white/80 sm:text-xs">
